...
about:Button("kunkun飞行",function()
...
about:Button("美猴王",function()
    local sound = Instance.new("Sound")
    sound.SoundId = "rbxassetid://8195914641"
    sound.Parent = game.Workspace
    sound:Play()
    end)
about:Button("鸡肉卷",function()
    local sound = Instance.new("Sound")
